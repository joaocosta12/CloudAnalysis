...
class ObjectScene{
	...
	double newCentroidX, newCentroidY, newCentroidZ;
	double theta;	
	int semanticValue;
	...
	double getNewCentroidX(){
		return centroidX;	
	}
	double getNewCentroidY(){
		return centroidY;	
	}
	double getNewCentroidZ(){
		return centroidZ;	
	}
	...
	void createBox(){
		...
		newCentroidX = (limitSupX + limitInfX)/2;
		newCentroidY = (limitSupY + limitInfY)/2;
		newCentroidZ = (limitSupZ + limitInfZ)/2;
		
		width = abs(limitInfX - limitSupX);
		height = abs(limitInfY - limitSupY);
		lenght = abs(limitInfZ - limitSupZ);
...
void pointCloudGenerator(){
    ...
    Mat img1, img2;
    img1 = imread("left190.png");
    img2 = imread("right190.png");
    ...
    ofstream center_cloud_file;
    center_cloud_file.open ("center_cloud.xyz");
    for(int i = 0; i < points0.rows; i++) {
        for(int j = 0; j < points0.cols; j++) {
            if(points0.at<Vec3f>(i,j)[2] < 10) {
                center_cloud_file << points0.at<Vec3f>(i,j)[0] << " " << points0.at<Vec3f>(i,j)[1] << " " << points0.at<Vec3f>(i,j)[2] << " " << static_cast<unsigned>(img1.at<uchar>(i,j)) << " " << static_cast<unsigned>(img3.at<Vec3b>(i,j)[0]) << " " << static_cast<unsigned>(img3.at<Vec3b>(i,j)[1]) << " " << static_cast<unsigned>(img3.at<Vec3b>(i,j)[2])  << endl;
            }
        }
    }
    center_cloud_file.close();

    ofstream create_file;
    create_file.open ("output_tupla.txt");
    create_file.close();
...
void fillingCloud(ObjectScene &car, ObjectScene &street, ObjectScene &tree, ObjectScene &sky, ObjectScene &sidewalk, ObjectScene &house, ObjectScene &error){
...
void centerCloud(ObjectScene &car, ObjectScene &street, ObjectScene &tree, ObjectScene &sky, ObjectScene &sidewalk, ObjectScene &house, ObjectScene &error){

//AMARELO - CAR - 0 255 255
//MARROM - SIDEWALK - 23 51 92
//LARANJA - STREET - 0 127 255 

	fstream reader_file;
	reader_file.open ("center_cloud.xyz");
		
	if(reader_file.is_open()){    

//CENTRO DE MASSA				
/*
		reader_file << car.getCentroidX() << " " << car.getCentroidY() <<  " " << car.getCentroidZ() <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
		for(double i=0; i<7; i++){
			for(double j=0; j<7;j++){
				for(double k=0;k<7;k++){
					reader_file << car.getCentroidX()+(i/1000) << " " << car.getCentroidY()+(j/1000) <<  " " << car.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getCentroidX()-(i/1000) << " " << car.getCentroidY()+(j/1000) <<  " " << car.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getCentroidX()+(i/1000) << " " << car.getCentroidY()-(j/1000) <<  " " << car.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getCentroidX()-(i/1000) << " " << car.getCentroidY()-(j/1000) <<  " " << car.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getCentroidX()+(i/1000) << " " << car.getCentroidY()+(j/1000) <<  " " << car.getCentroidZ()-(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
...
//CENTROID
/*
		reader_file << car.getNewCentroidX() << " " << car.getNewCentroidY() <<  " " << car.getNewCentroidZ() <<  " " << 0 <<  " " << 0 <<  " " << 127 <<  " " << 255 << endl;
		for(double i=0; i<7; i++){
			for(double j=0; j<7;j++){
				for(double k=0;k<7;k++){
					reader_file << car.getNewCentroidX()+(i/1000) << " " << car.getNewCentroidY()+(j/1000) <<  " " << car.getNewCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 127 <<  " " << 255 << endl;
					reader_file << car.getNewCentroidX()-(i/1000) << " " << car.getNewCentroidY()+(j/1000) <<  " " << car.getNewCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 127 <<  " " << 255 << endl;
					reader_file << car.getNewCentroidX()+(i/1000) << " " << car.getNewCentroidY()-(j/1000) <<  " " << car.getNewCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 127 <<  " " << 255 << endl;
					reader_file << car.getNewCentroidX()-(i/1000) << " " << car.getNewCentroidY()-(j/1000) <<  " " << car.getNewCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 127 <<  " " << 255 << endl;
					reader_file << car.getNewCentroidX()+(i/1000) << " " << car.getNewCentroidY()+(j/1000) <<  " " << car.getNewCentroidZ()-(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 127 <<  " " << 255 << endl;
...
//LIMITE SUPERIOR
		...
		reader_file << car.getLimitSupX() << " " << car.getCentroidY() <<  " " << car.getCentroidZ() <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
		for(double i=0; i<4; i++){
			for(double j=0; j<4;j++){
				for(double k=0;k<4;k++){
					reader_file << car.getLimitSupX()+(i/1000) << " " << car.getCentroidY()+(j/1000) <<  " " << car.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getLimitSupX()-(i/1000) << " " << car.getCentroidY()+(j/1000) <<  " " << car.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getLimitSupX()+(i/1000) << " " << car.getCentroidY()-(j/1000) <<  " " << car.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getLimitSupX()-(i/1000) << " " << car.getCentroidY()-(j/1000) <<  " " << car.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getLimitSupX()+(i/1000) << " " << car.getCentroidY()+(j/1000) <<  " " << car.getCentroidZ()-(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
		...
		reader_file << car.getCentroidX() << " " << car.getLimitSupY() <<  " " << car.getCentroidZ() <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
		for(double i=0; i<4; i++){
			for(double j=0; j<4;j++){
				for(double k=0;k<4;k++){
					reader_file << car.getCentroidX()+(i/1000) << " " << car.getLimitSupY()+(j/1000) <<  " " << car.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getCentroidX()-(i/1000) << " " << car.getLimitSupY()+(j/1000) <<  " " << car.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getCentroidX()+(i/1000) << " " << car.getLimitSupY()-(j/1000) <<  " " << car.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getCentroidX()-(i/1000) << " " << car.getLimitSupY()-(j/1000) <<  " " << car.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getCentroidX()+(i/1000) << " " << car.getLimitSupY()+(j/1000) <<  " " << car.getCentroidZ()-(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
		...
		reader_file << car.getCentroidX() << " " << car.getCentroidY() <<  " " << car.getLimitSupZ() <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
		for(double i=0; i<4; i++){
			for(double j=0; j<4;j++){
				for(double k=0;k<4;k++){
					reader_file << car.getCentroidX()+(i/1000) << " " << car.getCentroidY()+(j/1000) <<  " " << car.getLimitSupZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getCentroidX()-(i/1000) << " " << car.getCentroidY()+(j/1000) <<  " " << car.getLimitSupZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getCentroidX()+(i/1000) << " " << car.getCentroidY()-(j/1000) <<  " " << car.getLimitSupZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getCentroidX()-(i/1000) << " " << car.getCentroidY()-(j/1000) <<  " " << car.getLimitSupZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getCentroidX()+(i/1000) << " " << car.getCentroidY()+(j/1000) <<  " " << car.getLimitSupZ()-(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
...
//LIMITE INFERIOR
		...
		reader_file << car.getLimitInfX() << " " << car.getCentroidY() <<  " " << car.getCentroidZ() <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
		for(double i=0; i<4; i++){
			for(double j=0; j<4;j++){
				for(double k=0;k<4;k++){
					reader_file << car.getLimitInfX()+(i/1000) << " " << car.getCentroidY()+(j/1000) <<  " " << car.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getLimitInfX()-(i/1000) << " " << car.getCentroidY()+(j/1000) <<  " " << car.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getLimitInfX()+(i/1000) << " " << car.getCentroidY()-(j/1000) <<  " " << car.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getLimitInfX()-(i/1000) << " " << car.getCentroidY()-(j/1000) <<  " " << car.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getLimitInfX()+(i/1000) << " " << car.getCentroidY()+(j/1000) <<  " " << car.getCentroidZ()-(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
		...
		reader_file << car.getCentroidX() << " " << car.getLimitInfY() <<  " " << car.getCentroidZ() <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
		for(double i=0; i<4; i++){
			for(double j=0; j<4;j++){
				for(double k=0;k<4;k++){
					reader_file << car.getCentroidX()+(i/1000) << " " << car.getLimitInfY()+(j/1000) <<  " " << car.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getCentroidX()-(i/1000) << " " << car.getLimitInfY()+(j/1000) <<  " " << car.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getCentroidX()+(i/1000) << " " << car.getLimitInfY()-(j/1000) <<  " " << car.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getCentroidX()-(i/1000) << " " << car.getLimitInfY()-(j/1000) <<  " " << car.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getCentroidX()+(i/1000) << " " << car.getLimitInfY()+(j/1000) <<  " " << car.getCentroidZ()-(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
		...
		reader_file << car.getCentroidX() << " " << car.getCentroidY() <<  " " << car.getLimitInfZ() <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
		for(double i=0; i<4; i++){
			for(double j=0; j<4;j++){
				for(double k=0;k<4;k++){
					reader_file << car.getCentroidX()+(i/1000) << " " << car.getCentroidY()+(j/1000) <<  " " << car.getLimitInfZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getCentroidX()-(i/1000) << " " << car.getCentroidY()+(j/1000) <<  " " << car.getLimitInfZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getCentroidX()+(i/1000) << " " << car.getCentroidY()-(j/1000) <<  " " << car.getLimitInfZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getCentroidX()-(i/1000) << " " << car.getCentroidY()-(j/1000) <<  " " << car.getLimitInfZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
					reader_file << car.getCentroidX()+(i/1000) << " " << car.getCentroidY()+(j/1000) <<  " " << car.getLimitInfZ()-(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 255 <<  " " << 255 << endl;
...
//STREET
		reader_file << street.getCentroidX() << " " << street.getCentroidY() <<  " " << street.getCentroidZ() <<  " " << 0 <<  " " << 0 <<  " " << 127 <<  " " << 255 << endl;
		for(double i=0; i<7; i++){
			for(double j=0; j<7;j++){
				for(double k=0;k<7;k++){
					reader_file << street.getCentroidX()+(i/1000) << " " << street.getCentroidY()+(j/1000) <<  " " << street.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 127 <<  " " << 255 << endl;
					reader_file << street.getCentroidX()-(i/1000) << " " << street.getCentroidY()+(j/1000) <<  " " << street.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 127 <<  " " << 255 << endl;
					reader_file << street.getCentroidX()+(i/1000) << " " << street.getCentroidY()-(j/1000) <<  " " << street.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 127 <<  " " << 255 << endl;
					reader_file << street.getCentroidX()-(i/1000) << " " << street.getCentroidY()-(j/1000) <<  " " << street.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 127 <<  " " << 255 << endl;
					reader_file << street.getCentroidX()+(i/1000) << " " << street.getCentroidY()+(j/1000) <<  " " << street.getCentroidZ()-(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 127 <<  " " << 255 << endl;
...
//SIDEWALK
		reader_file << sidewalk.getCentroidX() << " " << sidewalk.getCentroidY() <<  " " << sidewalk.getCentroidZ() <<  " " << 0 <<  " " << 180 <<  " " << 130 <<  " " << 70 << endl;
		for(double i=0; i<7; i++){
			for(double j=0; j<7;j++){
				for(double k=0;k<7;k++){
					reader_file << sidewalk.getCentroidX()+(i/1000) << " " << sidewalk.getCentroidY()+(j/1000) <<  " " << sidewalk.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 180 <<  " " << 130 <<  " " << 70 << endl;
					reader_file << sidewalk.getCentroidX()-(i/1000) << " " << sidewalk.getCentroidY()+(j/1000) <<  " " << sidewalk.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 180 <<  " " << 130 <<  " " << 70 << endl;
					reader_file << sidewalk.getCentroidX()+(i/1000) << " " << sidewalk.getCentroidY()-(j/1000) <<  " " << sidewalk.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 180 <<  " " << 130 <<  " " << 70 << endl;
					reader_file << sidewalk.getCentroidX()-(i/1000) << " " << sidewalk.getCentroidY()-(j/1000) <<  " " << sidewalk.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 180 <<  " " << 130 <<  " " << 70 << endl;
					reader_file << sidewalk.getCentroidX()+(i/1000) << " " << sidewalk.getCentroidY()+(j/1000) <<  " " << sidewalk.getCentroidZ()-(k/1000) <<  " " << 0 <<  " " << 180 <<  " " << 130 <<  " " << 70 << endl;
...
//BUILDINGS
		...
		reader_file << house.getCentroidX() << " " << house.getCentroidY() <<  " " << house.getCentroidZ() <<  " " << 0 <<  " " << 0 <<  " " << 0 <<  " " << 128 << endl;
		for(double i=0; i<7; i++){
			for(double j=0; j<7;j++){
				for(double k=0;k<7;k++){
					reader_file << house.getCentroidX()+(i/1000) << " " << house.getCentroidY()+(j/1000) <<  " " << house.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 0 <<  " " << 128 << endl;
					reader_file << house.getCentroidX()-(i/1000) << " " << house.getCentroidY()+(j/1000) <<  " " << house.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 0 <<  " " << 128 << endl;
					reader_file << house.getCentroidX()+(i/1000) << " " << house.getCentroidY()-(j/1000) <<  " " << house.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 0 <<  " " << 128 << endl;
					reader_file << house.getCentroidX()-(i/1000) << " " << house.getCentroidY()-(j/1000) <<  " " << house.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 0 <<  " " << 128 << endl;
					reader_file << house.getCentroidX()+(i/1000) << " " << house.getCentroidY()+(j/1000) <<  " " << house.getCentroidZ()-(k/1000) <<  " " << 0 <<  " " << 0 <<  " " << 0 <<  " " << 128 << endl;
...
//TREE
/*
		reader_file << tree.getCentroidX() << " " << tree.getCentroidY() <<  " " << tree.getCentroidZ() <<  " " << 0 <<  " " << 128 <<  " " << 0 <<  " " << 128 << endl;
		for(double i=0; i<7; i++){
			for(double j=0; j<7;j++){
				for(double k=0;k<7;k++){
					reader_file << tree.getCentroidX()+(i/1000) << " " << tree.getCentroidY()+(j/1000) <<  " " << tree.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 128 <<  " " << 0 <<  " " << 128 << endl;
					reader_file << tree.getCentroidX()-(i/1000) << " " << tree.getCentroidY()+(j/1000) <<  " " << tree.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 128 <<  " " << 0 <<  " " << 128 << endl;
					reader_file << tree.getCentroidX()+(i/1000) << " " << tree.getCentroidY()-(j/1000) <<  " " << tree.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 128 <<  " " << 0 <<  " " << 128 << endl;
					reader_file << tree.getCentroidX()-(i/1000) << " " << tree.getCentroidY()-(j/1000) <<  " " << tree.getCentroidZ()+(k/1000) <<  " " << 0 <<  " " << 128 <<  " " << 0 <<  " " << 128 << endl;
					reader_file << tree.getCentroidX()+(i/1000) << " " << tree.getCentroidY()+(j/1000) <<  " " << tree.getCentroidZ()-(k/1000) <<  " " << 0 <<  " " << 128 <<  " " << 0 <<  " " << 128 << endl;
...
//OUTROS CENTROIDS
/*
		reader_file << sidewalk.getCentroidX() << " " << sidewalk.getCentroidY() <<  " " << sidewalk.getCentroidZ() <<  " " << 0 <<  " " << 23 <<  " " << 51 <<  " " << 92 << endl;
		for(double i=0; i<25; i++){
			for(double j=0; j<25;j++){
				reader_file << sidewalk.getCentroidX()+(i/1000) << " " << sidewalk.getCentroidY()+(j/1000) <<  " " << sidewalk.getCentroidZ() <<  " " << 0 <<  " " << 23 <<  " " << 51 <<  " " << 92 << endl;
				reader_file << sidewalk.getCentroidX()-(i/1000) << " " << sidewalk.getCentroidY()+(j/1000) <<  " " << sidewalk.getCentroidZ() <<  " " << 0 <<  " " << 23 <<  " " << 51 <<  " " << 92 << endl;
				reader_file << sidewalk.getCentroidX()+(i/1000) << " " << sidewalk.getCentroidY()-(j/1000) <<  " " << sidewalk.getCentroidZ() <<  " " << 0 <<  " " << 23 <<  " " << 51 <<  " " << 92 << endl;
				reader_file << sidewalk.getCentroidX()-(i/1000) << " " << sidewalk.getCentroidY()-(j/1000) <<  " " << sidewalk.getCentroidZ() <<  " " << 0 <<  " " << 23 <<  " " << 51 <<  " " << 92 << endl;
			}
		...
		reader_file << house.getCentroidX() << " " << house.getCentroidY() <<  " " << house.getCentroidZ() <<  " " << 0 <<  " " << 0 <<  " " << 127 <<  " " << 255 << endl;
		for(double i=0; i<25; i++){
			for(double j=0; j<25;j++){
				reader_file << house.getCentroidX()+(i/1000) << " " << house.getCentroidY()+(j/1000) <<  " " << house.getCentroidZ() <<  " " << 0 <<  " " << 0 <<  " " << 127 <<  " " << 255 << endl;
				reader_file << house.getCentroidX()-(i/1000) << " " << house.getCentroidY()+(j/1000) <<  " " << house.getCentroidZ() <<  " " << 0 <<  " " << 0 <<  " " << 127 <<  " " << 255 << endl;
				reader_file << house.getCentroidX()+(i/1000) << " " << house.getCentroidY()-(j/1000) <<  " " << house.getCentroidZ() <<  " " << 0 <<  " " << 0 <<  " " << 127 <<  " " << 255 << endl;
				reader_file << house.getCentroidX()-(i/1000) << " " << house.getCentroidY()-(j/1000) <<  " " << house.getCentroidZ() <<  " " << 0 <<  " " << 0 <<  " " << 127 <<  " " << 255 << endl;
			}
...
void outputFile(ObjectScene &car, ObjectScene &street, ObjectScene &tree, ObjectScene &sky, ObjectScene &sidewalk, ObjectScene &house, ObjectScene &error){
	
	fstream output_file;
	output_file.open ("output_tupla.txt");
		
	if(output_file.is_open()){    

			
		output_file << car.getNewCentroidX() << " " << car.getNewCentroidY() << " " << car.getNewCentroidZ() << " " << car.getTheta() << " " << car.getWidth() << " " << car.getHeight() << " " << car.getLenght() << " " << car.getSemanticValue() << endl;		
		output_file << street.getNewCentroidX() << " " << street.getNewCentroidY() << " " << street.getNewCentroidZ() << " " << street.getTheta() << " " << street.getWidth() << " " << street.getHeight() << " " << street.getLenght() << " " << street.getSemanticValue() << endl;		
...
int main(int argc, char** argv)
{
	...
	ObjectScene car(1), street(2), sign(0), tree(3), sky(4), sidewalk(5), house(6), error(0);

	fillingCloud(car, street, tree, sky, sidewalk, house, error);	
	...
	centerCloud(car, street, tree, sky, sidewalk, house, error);
	

	//OUTPUT
	outputFile(car, street, tree, sky, sidewalk, house, error);
	//street.outputFile();
	//tree.outputFile();
	//sky.outputFile();
	//sidewalk.outputFile();
